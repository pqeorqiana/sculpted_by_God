...
$sql = "SELECT *
        ...
        WHERE id IN (
          SELECT useritest_id
          FROM useritest2
          JOIN traineritest2 ON useritest2.traineritest2_id = traineritest2.id
          WHERE traineritest_id = $traineritestId
        )
        LIMIT $start, $limit";
$result = mysqli_query($con, $sql);

$total_pages_sql = "SELECT COUNT(*) as count FROM useritest";
							...
							<div class="table-title">
								<div class="row">
									<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
										<h2 class="ml-lg-2">Lista Useri</h2>
									</div>
								...
								<table class="table">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger">
                                            <a href="stergereTU.php?deleteid=' . $id . '" class="text-light">Sterge</a>
                                        </button>
										<button class="btn btn-secondary">
                                            <a href="atribuire.php?atid=' . $id . '" class="text-light">Atribuie</a>
                                        </button>
                                    </td>
                                </tr>';
											}
