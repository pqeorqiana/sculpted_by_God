...
// Assuming the session ID is stored in a variable called $session_id
$session_id = $_SESSION['id'];

$sql = "SELECT e.id, e.nume, e.descriere, e.utilitate, e.demonstrare 
        FROM exercitii e
        INNER JOIN traineritest t ON e.traineritest_id = t.id
        WHERE t.id = $session_id
        LIMIT $start, $limit";

$result = mysqli_query($con, $sql);

$total_pages_sql = "SELECT COUNT(*) as count FROM `exercitii` WHERE traineritest_id = $session_id";
				...
				<div class="row">
					<div class="col-md-12">
						<div class="table-wrapper">
							<div class="table-title">
								<div class="row">
									<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
										<h2 class="ml-lg-2">Lista Exercitii</h2>
									</div>
									<div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
										<a href="adaugAntren.php" class="btn btn-success">
								...
								<table class="table">
									<thead>
										<tr>
											...
											<th scope="col"><b>Descriere</b></th>
											<th scope="col"><b>Utilitate</b></th>
											<th scope="col"><b>Demonstare</b></th>
							...
							<td>' . $descriere . '</td>
							<td>' . $utilitate . '</td>
							<td><img src="css/' . $demonstrare . '"></td>
							<td>
								<button class="btn btn-primary">
									<a href="updateAntren.php?updateid=' . $id . '" class="text-light">Update</a>
								</button>
								<button class="btn btn-danger">
									<a href="stergAntren.php?deleteid=' . $id . '" class="text-light">Sterge</a>
								</button>
							</td>
						</tr>';
											}
