...
$sql = "SELECT e.id, e.nume, e.descriere, e.utilitate, e.demonstrare 
        FROM exercitii e
        INNER JOIN atribuire a ON e.id = a.exercitii_id
        WHERE a.useritest_id = $session_id
        LIMIT $start, $limit";

$result = mysqli_query($con, $sql);

$total_pages_sql = "SELECT COUNT(*) as count FROM exercitii e
                    INNER JOIN atribuire a ON e.id = a.exercitii_id
                    WHERE a.useritest_id = $session_id";
				...
				<div class="xd-topbar">
					...
					<div class="xp-breadcrumbbar text-center">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active" aria-curent="page">Useri</li>
						</ol>
					</div>
