...
include 'urls.php';
$id = $_GET['updateid'];
$sql = "select * from `useritest` where id=$id";
...
if (isset($_POST['submit'])) {
	...
	$sql = "update `useritest` set id=$id, nume='$nume',email='$email',numartel='$numartel',parola='$parola' where id=$id";
	$result = mysqli_query($con, $sql);
	if ($result) {
							...
							<div class="table-title">
								<div class="row">
									<div class="col-sm-6 p-0 flex justify-content-lg-start justify-content-center">
										<h2 class="ml-lg-2">Editare Useri</h2>
									</div>
								...
								<form method="post">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" placeholder="Introdu nr tel"
											name="numartel" autocomplete="off" value=<?php echo $numartel; ?>>
									</div>
									<div class="form-group">
										<label>Parola</label>
										<input type="text" class="form-control" placeholder="Introdu parola"
											name="parola" autocomplete="off" value=<?php echo $parola; ?>>
									...
									<div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
										<a href="altTest.php" class="btn btn-success">
