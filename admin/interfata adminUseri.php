...
$sql = "SELECT * FROM `useritest` LIMIT $start, $limit";
							...
							<div class="table-title">
								<div class="row">
									...
									<div class="col-sm-6 p-0 flex justify-content-lg-end justify-content-center">
										<a href="adaugaUs.php" class="btn btn-success">
								...
								<table class="table">
                                    ...
                                    <td>
                                        <button class="btn btn-primary">
                                            <a href="updateUseriPHP.php?updateid=' . $id . '" class="text-light">Update</a>
                                        </button>
                                        <button class="btn btn-danger">
                                            <a href="stergereUseriPHP.php?deleteid=' . $id . '" class="text-light">Sterge</a>
                                        </button>
                                    </td>
                                </tr>';
											}
